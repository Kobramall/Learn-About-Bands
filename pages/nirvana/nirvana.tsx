...
<div className="nirvanaHome h-screen w-screen text-center">
          ...
          <h1 className="text-white opacity-80 text-2xl mt-16">Learn more about Nirvana or take a quiz to test your knowledge</h1>
           ...
           <div className="flex justify-center"><Link href="/nirvana/funfact" className="mt-4">Fun Facts</Link></div>
           <div className="flex justify-center"><Link href="/nirvana/stats" className="mt-4">Stats</Link></div>
