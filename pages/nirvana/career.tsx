...
const Career = () => {
  ...
  return(
    <div className="flex-col text-center bg-gradient-to-tr from-yellow-500 to-black min-h-screen text-white ">
    <Header />
    <h3 className="text-3xl pt-3 mb-2">How It Start</h3>
    <div className="flex text-center">
        <div className=" flex shadow-2xl p-2 text-2xl bg-gradient-to-tr from-black to-yellow-500">
          <Image src="https://ychef.files.bbci.co.uk/976x549/p01wvg0v.jpg" width={500} height={500} alt="band photo"/>
    ...
    <div className="flex text-center">
      <div className=" flex shadow-2xl p-2 text-2xl bg-gradient-to-tr from-black to-yellow-500">
        <Image src="https://wallup.net/wp-content/uploads/2019/09/08/419549-nirvana-alternative-grunge-hard-rock-748x374.jpg" width={500} height={800} alt="band photo"/>
    ...
    <div className="flex text-center">
      <div className=" flex shadow-2xl p-2 text-2xl mb-9 bg-gradient-to-tr from-black to-yellow-500">
        <Image src="https://townsquare.media/site/366/files/2014/11/Nirvana.jpg?w=980&q=75" width={500} height={300} alt="band photo"/>
        <p className="p-2 mt-9">When we started, we were the worst band ever, playing the worst music you have ever heard said Pete Wentz of himslef and his band members. The band had very humble beginnings in Wilmette Illnois.  
         Pete Wentz and Joe Trohman tried their hand at a metal band but were unsuccesful. They joked about starting new pop punk band but soon it would no longer be a joke but reality.
         By what seemed like fate Joe over heard Patrick Stump talk about a band an jumped in the conversation. They agreed to meet up and practice and so the roots of the band were formed over a mutal love for Neurosis.
         After that it was a matter of finding a drummer. Luckly Patrick knew Andy Hurley who joined on. As Pete said they made have been bad at first but with work and decatiction, they would become one of the most up and coming bands in the nation 
        </p>
