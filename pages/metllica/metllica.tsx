...
const MetllicaHome = () =>{
    ...
    return(
      ...
      <div className="metllicaNav text-white flex justify-evenly text-xl bg-gradient-to-r from-red-900 to-transparent opacity-50 h-16">
          ...
          <div className="flex justify-center"><Link href="/metllica/funfact" className="mt-4">Fun Facts</Link></div>
          <div className="flex justify-center"><Link href="/metllica/stats" className="mt-4">Stats</Link></div>
